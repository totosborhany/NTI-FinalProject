import { getCommentsByTaskService, createCommentService, deleteCommentService } from '../services/comments.service.js';
...
//   const comment = await updateCommentService(req.params.commentId, req.body,req.user.id, req.file);
